  ...
  const SidebarContent = () => (
    <div className="h-full flex flex-col font-sans bg-card border-r border-border custom-scrollbar">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <Link
          href="/review"
          className="flex items-center gap-3 px-3 py-3 text-sm font-bold text-white bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all group"
        >
