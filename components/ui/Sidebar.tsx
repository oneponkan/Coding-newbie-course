...
import { CheckCircle, Circle, Lock, BrainCircuit, ChevronDown, ChevronRight, PanelLeftClose, PanelLeftOpen } from "lucide-react";
    ...
    return (
        <div className="h-full flex flex-col font-sans bg-card border-r border-border custom-scrollbar">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
                ...
                <Link
                    href="/review"
                    className="flex items-center gap-3 px-3 py-3 text-sm font-bold text-white bg-linear-to-r from-purple-500 to-indigo-600 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all group"
                >
            ...
            <div className="py-4 pr-4 pl-8 border-t border-border">
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative w-10 h-10 shrink-0">
                        <Image src="/avatar-orange-v2.png" alt="學徒橘子" fill className="object-contain" />
                    </div>
                    <div>
...
export function Sidebar() {
  ...
  // Helper to toggle appropriate state
      ...
      <AnimatePresence>
        {isOpen && isMobile && (
          <>
            ...
            >
              <SidebarContent onClose={() => setIsOpen(false)} isMobile={isMobile} />
            </motion.aside>
          </>
        )}
      </AnimatePresence>
